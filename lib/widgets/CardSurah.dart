...
class CardSurah extends StatelessWidget {
  ...
  final String title, subtitle, surah, surahImage, ayah, arabic;
            ...
            return Column(
              children: <Widget>[
                ListTile(
                  ...
                  trailing: new Image.asset(surahImage, width: 100,),
                  ...
                  subtitle: new Text(ayah+' Ayat', textAlign: TextAlign.left,),
                ),
                Divider()
              ],
            );
